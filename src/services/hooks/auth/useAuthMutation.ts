...
import { PartialSessionInt } from "@/types/SessionTypes";
...
type OpenBoxParams = { id: string; bulk: PartialSessionInt };
...
export type SignInMutationOptions = UseMutationOptions<
  SessionResponse,
  AxiosError,
  PartialAccountType | null
>;
export type SignInMutationResult = UseMutationResult<
  SessionResponse,
  AxiosError,
  PartialAccountType | null
>;
...
export const useCreateSessionMutation = (
  options?: UseMutationOptions<SessionResponse, AxiosError, createSessionParams>
) => {
...
export const useOpenBoxMutation = (
  params?: null,
  options?: UseMutationOptions<
    remakeSessionResponse,
    Error,
    OpenBoxParams,
    unknown
  >
