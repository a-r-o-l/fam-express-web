...
type updateAccountBulk = PartialAccountInt | { session: null };

type UpdateAccountParams = { id: string; bulk: updateAccountBulk };
type DeleteAccountParams = { id: string };

export const useCreateAccountMutation = (
  params?: CreateAccountParams,
  options?: UseMutationOptions<unknown, Error, CreateAccountParams, unknown>
) => {
  return useMutation({
...
export const useUpdateAccountMutation = (
  params?: null,
  options?: UseMutationOptions<unknown, Error, UpdateAccountParams, unknown>
) => {
  return useMutation({
...
export const useDeleteAccountMutation = (
  params?: null,
  options?: UseMutationOptions<unknown, Error, DeleteAccountParams, unknown>
) => {
  return useMutation({
